...
> |-------|-------|-----------|
> | General | 72 | Owned fetch to basics. |
> | Deck-Specific | 74 | Owned fetch to basics. |
> | **Combined** | **73** | Owned fetch to basics. |
>
> ### Classification
>
> | Category | Links |
...
<div class="synergy-score"><div class="synergy-score-num">73<span>/100</span></div><p class="synergy-score-why">Owned fetch to basics. General 72 and Deck-Specific 74 produce Combined 73.</p></div>

## Oracle Text

{T}, Sacrifice this land: [[03 Effects/Tutor|Search your library for a basic land card, put it onto the battlefield tapped, then shuffle]].

---

## Deck Role & Rating

Evolving Wilds is a mana source for this Azorius pile. Owned fetch to basics. The live base is Island ×8 / Plains ×6 plus [[02 Cards/Lands/Command Tower|Command Tower]]; duals are almost all on the buy list ([[02 Cards/Lands/Hallowed Fountain|Hallowed Fountain]], Floodfarm Verge). Do not treat this as a spell that triggers [[02 Cards/Creatures/Kykar, Zephyr Awakener|Kykar, Zephyr Awakener]].
...
- Crack for an Island or Plains, not a second colour you do not have.
