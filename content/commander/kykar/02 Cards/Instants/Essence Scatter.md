...
> |-------|-------|-----------|
> | General | 72 | Owned. Creature counter. Fine sleeve. |
> | Deck-Specific | 74 | Owned. Creature counter. Fine sleeve. |
> | **Combined** | **73** | Owned. Creature counter. Fine sleeve. |
>
> ### Classification
>
> | Category | Links |
...
> | Effect | Notes |
> |--------|-------|
> | [[03 Effects/Counter\|Counter]] | Counter target creature spell |

### Combined Deck Synergy Score

<div class="synergy-score"><div class="synergy-score-num">73<span>/100</span></div><p class="synergy-score-why">Owned. Creature counter. Fine sleeve. General 72 and Deck-Specific 74 produce Combined 73.</p></div>

## Oracle Text

[[03 Effects/Counter|Counter target creature spell]].

---

## Deck Role & Rating

Essence Scatter is interaction at {1}{U}. Hold it for the spell that would remove [[02 Cards/Creatures/Kykar, Zephyr Awakener|Kykar, Zephyr Awakener]] or stop a Deadeye turn. Noncreature, so Kykar blinks or makes a Spirit. Owned. Creature counter. Fine sleeve.

## Play Patterns & Lines

- Hold for the removal on Kykar or the counter on a Deadeye activation.
- Noncreature, so Kykar triggers even if you miss.
- Offer is the live hard-ish counter. Lofty Denial needs a flyer (Kykar).
