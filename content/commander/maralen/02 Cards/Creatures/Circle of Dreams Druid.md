...
>
> ![Circle](https://cards.scryfall.io/border_crop/front/b/e/be6fdec0-a2c4-4da2-ae14-961185eaee66.jpg?1783926466)
>
> ### Deck Scores
>
> | Score | Value | Breakdown |
> |-------|-------|-----------|
> | General | 83 | Ritual Elf. {G}{G}{G} is the tax; the tap is a pile of green. |
> | Deck-Specific | 92 | Counts every creature you control, including Faeries. Funds Genesis Wave. |
> | **Combined** | **88** | Counts every creature you control, including Faeries. Funds Genesis Wave. |
>
> ### Classification
>
> | Category | Links |
...
> | Effect | Notes |
> |--------|-------|
> | [[03 Effects/Add Mana\|Add Mana]] | {T}: Add {G} for each creature you control |

### Combined Deck Synergy Score

<div class="synergy-score"><div class="synergy-score-num">88<span>/100</span></div><p class="synergy-score-why">Counts every creature you control, including Faeries. That mana turns Genesis Wave into a close. General 83 and Deck-Specific 92 produce Combined 88.</p></div>

## Oracle Text

{T}: [[03 Effects/Add Mana|Add]] {G} for each creature you control.
