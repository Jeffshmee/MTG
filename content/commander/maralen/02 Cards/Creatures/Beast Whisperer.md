...
> [!card-proxy] **`mtg:Beast Whisperer`**
>
> **Status:** Main Deck  
> **Mana Cost:** {2}{G}{G}  
...
>
> ![Beast](https://cards.scryfall.io/border_crop/front/d/a/daf4bcd2-3ae4-4803-9ea1-3bcc3de5ca59.jpg?1783912531)
>
> ### Deck Scores
>
> | Score | Value | Breakdown |
> |-------|-------|-----------|
> | General | 84 | Elf that draws on every creature spell. |
> | Deck-Specific | 90 | Elf that draws on every creature spell. |
> | **Combined** | **88** | Elf that draws on every creature spell. |
>
> ### Classification
>
> | Category | Links |
...
<div class="synergy-score"><div class="synergy-score-num">88<span>/100</span></div><p class="synergy-score-why">Elf that draws on every creature spell. General 84 and Deck-Specific 90 produce Combined 88.</p></div>
...
- Tokens are not creature spells. Imperious activations and Lathril combat do not refill.
- {2}{G}{G} is dead early and does nothing the turn you have no follow-up creatures.
- 2/3. Dies to most removal, and the engine leaves with it.
...
>   deck_specific: 90
>   combined: 88
> scryfall_id: daf4bcd2-3ae4-4803-9ea1-3bcc3de5ca59
> tags:
>   - card
>   - main-deck
>   - creature
