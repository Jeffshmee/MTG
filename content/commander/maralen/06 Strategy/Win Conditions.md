...
How this list closes a table. All four plans run through [[02 Cards/Creatures/Maralen, Fae Ascendant|Maralen, Fae Ascendant]] and a stream of Elves plus the live Faeries.
...
## 1. Steal — free spells off Maralen

**How it wins:** each Elf or Faerie ETB mills two from an opponent. Once a turn you cast one of those cards for free if your Elf + Faerie count is high enough. The stolen spell is whatever their deck was doing — often better than anything in your hand.
...
## 2. Combat — go wide with Elves

**How it wins:** token Elves plus lords connect. Lathril is the engine; Imperious is the factory; Archdruid / Banner / Loyalist are the anthems. [[02 Cards/Enchantments/Garruk's Uprising|Garruk's Uprising]] gives trample and turns 4-power ETBs into cards once the lords are on.
...
## 3. Wave — ritual into Genesis Wave

**How it wins:** a wide Elf board plus Archdruid pays for a large [[02 Cards/Sorceries/Genesis Wave|Genesis Wave]]. Permanents with mana value ≤ X enter. Every Elf or Faerie that hits triggers Maralen, and the board is often lethal on the next combat.
...
## 4. Attrition — Morcant blight, then mill

**How it wins:** [[02 Cards/Creatures/High Perfect Morcant|High Perfect Morcant]] turns every Elf ETB into blight. Proliferate as a sorcery. Their board shrinks while Maralen keeps exiling libraries. Combat and Thornweald finish whoever still has cards.
...
Do not sit back and only mill. The owned list is not a dedicated mill deck.
