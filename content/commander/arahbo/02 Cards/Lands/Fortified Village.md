...
> [!card-proxy] **`mtg:Fortified Village`**
>
> **Status:** Main Deck  
> **Mana Cost:** —  
> **Type:** Land  
...
> | [[03 Effects/Add Mana\|Add Mana]] | {T}: Add {G} or {W} |
...
As this land enters, you may reveal a Forest or Plains card from your hand. If you don't, this land [[03 Effects/Enters Tapped|enters tapped]].
{T}: [[03 Effects/Add Mana|Add]] {G} or {W}.

---

## Deck Role & Rating

[[02 Cards/Lands/Fortified Village|Fortified Village]] is {G} or {W}, untapped if you reveal a Forest or Plains from hand. The reveal dual. Keep a basic in hand to show.

## Play Patterns & Lines

- Reveal Plains or Forest. Sequence a white Cat on 1–2.
- If the hand has no basic to show, it enters tapped — treat it as Guildgate.

## Key Synergies

- **Commander**: [[02 Cards/Creatures/Arahbo, Roar of the World|Arahbo, Roar of the World]]
- **Untapped**: [[02 Cards/Lands/Command Tower|Command Tower]], [[02 Cards/Lands/Plains|Plains]], [[02 Cards/Lands/Forest|Forest]], [[02 Cards/Lands/Temple Garden|Temple Garden]]

## Anti-synergies / Notes

- No basic in hand = tapped. Do not keep it as the only coloured source with Secret Tunnel.
